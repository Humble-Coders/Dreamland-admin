...
> Last updated: 2026-04-17 (meal plans now store `{ value, price }`)
...
| `overrides.amenities` | string[] | — | Per-room amenities override |
| `overrides.smokingAllowed` | boolean | — | Per-room smoking override |
| `overrides.available` | boolean | — | Per-room availability override |
| `overrides.floor` | string | — | Per-room floor override |
| `overrides.notes` | string | — | Internal notes |
| `createdAt` | timestamp | — | Read-only |
